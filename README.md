# SwarmStorm's Stars \[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)]
...
* [LiveViewTech/lvt-public-api](https://github.com/LiveViewTech/lvt-public-api) -

* [human-bee/office-365-mcp-server](https://github.com/human-bee/office-365-mcp-server) - A Model Context Protocol (MCP) server for Microsoft 365 integration. Provides 24 consolidated tools for email, calendar, Teams, planner, and notifications through the Microsoft Graph API.
...
* [nikgraf/awesome-serverless-1](https://github.com/nikgraf/awesome-serverless-1) - Curated list of resources related to serverless architectures and the Serverless Framework
...
* [201flaviosilva-labs/Open-Source-Games](https://github.com/201flaviosilva-labs/Open-Source-Games) - :video\_game: A list of popular/awesome video games. Any genre. Any platform. Any engine.

* [dotnet/docs](https://github.com/dotnet/docs) - This repository contains .NET Documentation.

* [Vraepz/captcha-detector-parameters](https://github.com/Vraepz/captcha-detector-parameters) -

* [ai-collection/ai-collection](https://github.com/ai-collection/ai-collection) - The Generative AI Landscape - A Collection of Awesome Generative AI Applications

* [numandev1/open-source-react-native-apps](https://github.com/numandev1/open-source-react-native-apps) - 📱 Collaborative List of Open-Source React Native Apps

* [SwarmStorm/hirewise-ai](https://github.com/SwarmStorm/hirewise-ai) - AI Web App to streamline Recruiting. Uses AI to match the best applicant for the role based on their resume.

* [gersondi/AI-job-recruiter](https://github.com/gersondi/AI-job-recruiter) - A recruitment chatbot powered by AI
...
* [kornbed/jira-mcp-server](https://github.com/kornbed/jira-mcp-server) - A TypeScript-based MCP server for Jira integration with Cursor
...
* [xianjianlf2/MindGeniusAI](https://github.com/xianjianlf2/MindGeniusAI) - An AI agent that reads your PDFs and draws editable mind maps — visible tool-calling loop, built-in RAG, bring-your-own-key, multi-provider (OpenAI / Claude / DeepSeek / Kimi). Self-hostable.
...
* [maggike/Full-Stack-AI-Course-Creator-Learning-Journey](https://github.com/maggike/Full-Stack-AI-Course-Creator-Learning-Journey) - Learning journey - Your ultimate 1-stop learning platform to generate the best learning courses tailored to your needs using Open AI's immensely powerful LLM - GPT4

* [ajaymahadeven/Scalable-Full-Stack-Setup-Next.js-Azure-Functions-and-PostgreSQL](https://github.com/ajaymahadeven/Scalable-Full-Stack-Setup-Next.js-Azure-Functions-and-PostgreSQL) - This example demonstrates deploying a Next.js app to Azure Functions. The architecture consists of a front-end, Azure Functions as middleware, and a PostgreSQL database (using Docker), forming the back-end. The front-end communicates with the back-end through the middleware, ensuring a detachable front-end.
...
* [stevenGarciaDev/simple-meditation-app-expo-react-native](https://github.com/stevenGarciaDev/simple-meditation-app-expo-react-native) -
...
* [akinncar/expo-stack](https://github.com/akinncar/expo-stack) - 🎮🧱 Stack game clone made in Expo (iOS, Android, Web), Three.js, React Native

* [jtvargas/TheLock](https://github.com/jtvargas/TheLock) - Mobile game made with React Native and Expo
...
* [aklinker1/publish-browser-extension](https://github.com/aklinker1/publish-browser-extension) - CI tool to easily publish browser extensions
...
* [docker/setup-docker-action](https://github.com/docker/setup-docker-action) - GitHub Action to set up (download and install) Docker CE
...
* [digitalocean/ghost-writer](https://github.com/digitalocean/ghost-writer) - Agentic Blogging
...
* [kyegomez/LFM](https://github.com/kyegomez/LFM) - An open source implementation of LFMs from Liquid AI: Liquid Foundation Models

* [denisalevi/bib4llm](https://github.com/denisalevi/bib4llm) - Convert your PDF library into LLM-readable format for AI-assisted research.
...
* [tuansunday05/fe8kv9](https://github.com/tuansunday05/fe8kv9) -  YOLOv9-FishEye: Improving method for fisheye camera object detection

* [Wan-Video/Wan2.1](https://github.com/Wan-Video/Wan2.1) - Wan: Open and Advanced Large-Scale Video Generative Models

* [showlab/videollm-online](https://github.com/showlab/videollm-online) - VideoLLM-online: Online Video Large Language Model for Streaming Video (CVPR 2024)
...
* [VAST-AI-Research/UniRig](https://github.com/VAST-AI-Research/UniRig) - \[SIGGRAPH 2025] One Model to Rig Them All: Diverse Skeleton Rigging with UniRig

* [public-apis/public-apis](https://github.com/public-apis/public-apis) - A collective list of free APIs

* [Ravi-Teja-konda/Surveillance\_Video\_Summarizer](https://github.com/Ravi-Teja-konda/Surveillance_Video_Summarizer) - VLM driven tool that processes surveillance videos, extracts frames, and generates insightful annotations using a fine-tuned Florence-2 Vision-Language Model. Includes a Gradio-based interface for querying and analyzing video footage.

* [Zie619/n8n-workflows](https://github.com/Zie619/n8n-workflows) - all of the workflows of n8n i could find (also from the site itself)

* [devnen/Chatterbox-TTS-Server](https://github.com/devnen/Chatterbox-TTS-Server) - Self-host the powerful Chatterbox TTS model. This server offers a user-friendly Web UI, flexible API endpoints (incl. OpenAI compatible), predefined voices, voice cloning, and large audiobook-scale text processing. Runs accelerated on NVIDIA (CUDA), AMD (ROCm), and CPU.
...
* [AdirthaBorgohain/reportAI](https://github.com/AdirthaBorgohain/reportAI) - Generate full fledged PDF reports using LLMs like GPT, Claude, Llama
...
* [agniiva/StockAnalystAI](https://github.com/agniiva/StockAnalystAI) - A sophisticated financial analysis bot powered by OpenAI, designed to provide in-depth financial insights and recommendations based on company data.
...
* [AlgoETS/AINewsTracker](https://github.com/AlgoETS/AINewsTracker) - AINewsTracker: Leveraging AI  to analyse financial news

* [manpreet171/Paper-Researcher-AI-Agent](https://github.com/manpreet171/Paper-Researcher-AI-Agent) -
...
* [pramodkoujalagi/Automated-Course-Content-Generator](https://github.com/pramodkoujalagi/Automated-Course-Content-Generator) - Automated Course Content Generator (ACCG) is an AI-powered Streamlit app for SMEs, Content Creators, and Educators. Input Course Name, Audience Level, Difficulty, and Credits to get a dynamic course outline, full course content, and quizzes. Download everything as a PDF, PPT and customize as needed!
...
* [olekenneth/viseron](https://github.com/olekenneth/viseron) - Self-hosted NVR with object detection
...
* [alonlavian/RAGent](https://github.com/alonlavian/RAGent) - When RAG and agents fall in love
...
* [linsomniac/spotify\_to\_ytmusic](https://github.com/linsomniac/spotify_to_ytmusic) - Copy playlists and liked music from Spotify to YTMusic
...
* [dtflare/GPTparser](https://github.com/dtflare/GPTparser) - Use GPTparser with your OpenAI API to scrape & parse files into structured JSON files.

* [trancethehuman/entities-extraction-web-scraper](https://github.com/trancethehuman/entities-extraction-web-scraper) - A web scraper that uses OpenAI Functions for selective scraping.
...
* [advancedtelematic/ota-community-edition](https://github.com/advancedtelematic/ota-community-edition) - End-to-end Over The Air updates
...
* [HariSekhon/Dockerfiles](https://github.com/HariSekhon/Dockerfiles) - 50+ DockerHub public images for Docker & Kubernetes - DevOps, CI/CD, GitHub Actions, CircleCI, Jenkins, TeamCity, Alpine, CentOS, Debian, Fedora, Ubuntu, Hadoop, Kafka, ZooKeeper, HBase, Cassandra, Solr, SolrCloud, Presto, Apache Drill, Nifi, Spark, Consul, Riak
...
* [HariSekhon/DevOps-Golang-tools](https://github.com/HariSekhon/DevOps-Golang-tools) - DevOps Golang tools
...
* [fifsky/ssh-action](https://github.com/fifsky/ssh-action) - 🖥 github ssh action
...
* [Abdulbasit110/Blog-writer-multi-agent](https://github.com/Abdulbasit110/Blog-writer-multi-agent) - Blog Write multi agent AI is a custom multi-agent system designed to autonomously create high-quality, research-driven blogs. Using LangChain, Gemini 2.0-Flash-EXP, and Serper Web Search Tool, it automates planning, writing, and editing to deliver human-like blogs with up-to-date references.

* [wow-world-model/wow-world-model](https://github.com/wow-world-model/wow-world-model) - WoW (World-Omniscient World Model) is a generative world model trained on 2 million robotic interaction trajectories, designed to imagine, reason, and act in the physical world. Unlike passive video models, WoW learns from real-world, causally rich data, enabling robust physical reasoning and real-world planning.

* [rahulnyk/knowledge\_graph](https://github.com/rahulnyk/knowledge_graph) - Convert any text to a graph of knowledge. This can be used for Graph Augmented Generation or Knowledge Graph based QnA

* [Sneh-T-Shah/Video-Interaction-Analysis](https://github.com/Sneh-T-Shah/Video-Interaction-Analysis) - Video-Interaction-Analysis is a pipeline that analyzes interactions between individuals in videos. It predicts gaze, emotions, engagement levels, and object interactions, enabling insights into human behavior across domains like therapy, education, and more. The pipeline integrates computer vision and natural language processing techniques.
...
* [aws-solutions-library-samples/fraud-detection-using-machine-learning](https://github.com/aws-solutions-library-samples/fraud-detection-using-machine-learning) - Setup end to end demo architecture for predicting fraud events with Machine Learning using Amazon SageMaker

* [SayamAlt/Fake-Reviews-Detection](https://github.com/SayamAlt/Fake-Reviews-Detection) - Successfully developed a machine learning model which can predict whether an online review is fraudulent or not. The main idea used to detect the fake nature of reviews is that the review should be computer generated through unfair means. If the review is created manually, then it is considered legal and original.
...
* [djb-gt/gpt-automated-web-scraper](https://github.com/djb-gt/gpt-automated-web-scraper) - The GPT-based Universal Web Scraper MVP is a solution that leverages GPT models and web scraping libraries to generate scraper code based on user input and website analysis, simplifying the web scraping process.
...
* [prajwalshettydev/UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport) - Unreal Engine plugin for LLM/GenAI models & MCP UE5 server. OpenAI GPT-5, Deepseek R1, Claude Opus/Sonnet, Gemini 3, Grok 4, Alibaba Qwen, Kimi, ElevenLabs TTS, Inworld, OpenRouter, Groq, GLM, Ollama, Local, Meshy, Tripo, Hunyuan3D, Rodin, fal, Dashscope, Seedream. NPC AI, agentic, chat, 3D gen, TTS, multimodal, image gen. UnrealMCP/UnrealClaude
...
* [workleap/wl-eventgrid-emulator](https://github.com/workleap/wl-eventgrid-emulator) - An open source emulator for Azure Event Grid that supports the push and pull delivery models, distributed as a Docker image.
...
* [Alliedium/awesome-github-actions](https://github.com/Alliedium/awesome-github-actions) - Discover a collection of GitHub Actions workflow examples that will supercharge your development process. Level up your projects with the efficiency and reliability of GitHub Actions, saving time and ensuring high-quality code
...
* [vidhi-mody/Apply-By-AI](https://github.com/vidhi-mody/Apply-By-AI) - A Recruitment Assisting platform which will help recruiters select the right candidates for a particular job profile and help connect users for collaborations.
...
* [HariSekhon/Terraform](https://github.com/HariSekhon/Terraform) - Terraform HCL code for AWS / GCP / Azure / GitHub management
...
* [ReversableCode/flutter\_static\_html\_wrapper](https://github.com/ReversableCode/flutter_static_html_wrapper) - A Flutter project to run html games / websites on mobile.
